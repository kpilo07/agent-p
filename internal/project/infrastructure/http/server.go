...
func (s *Server) Handler(dist fs.FS) http.Handler {
	...
	protected.HandleFunc("GET /api/projects/{id}/checkpoints", s.handleListCheckpoints)
	protected.HandleFunc("POST /api/projects/{id}/checkpoints", s.handleCreateCheckpoint)
	protected.HandleFunc("POST /api/projects/{id}/checkpoints/{cid}/restore", s.handleRestoreCheckpoint)
	protected.HandleFunc("DELETE /api/projects/{id}/checkpoints/{cid}", s.handleDeleteCheckpoint)
	...
	protected.HandleFunc("GET /api/projects/{id}/grep", s.handleProjectGrep)
	protected.HandleFunc("POST /api/projects/{id}/git/fetch", s.handleGitRemote(s.uc.GitFetch))
	protected.HandleFunc("POST /api/projects/{id}/git/push", s.handleGitRemote(s.uc.GitPush))
	protected.HandleFunc("POST /api/projects/{id}/git/pull", s.handleGitRemote(s.uc.GitPull))
